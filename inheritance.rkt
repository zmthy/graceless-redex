...
(define-metafunction/extension graceless:remove-object-shadows GI
...
(define-metafunction GI
  ...
  ;; the substitution continues into the clause's expression.
  [(subst s ... (object (s_i ... inherits e) M ... F ...))
   (object (s ... s_i ... inherits (subst s ... e)) M ... F ...)]
...
(define -->GI
  (reduction-relation
   ...
   (--> [(in-hole E (object (s_d ... inherits (ref ℓ))
        ...
        ;; methods, and substituted generated field methods.
        ...
        (where (s ...) ,(append-map (λ (s) (term (remove-shadows ,s m_i ...)))
                                      (term (s_d ...))))
        ;; Apply the delayed substitutions to the remaining object body, taking
        ;; into account self and method name shadowing as usual.
        (where (object M_p ... F_p ...) (subst s ... (object M ... F ...)))
        inherits)
